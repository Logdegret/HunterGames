...
The Cloudflare Worker under cloudflare/open-golf-worker/ handles WebSocket signaling for Open Golf party rooms. See cloudflare/open-golf-worker/README.md for deploy instructions.

Adding games
Games are declared as arrays/objects at the top of script.js. Each source has its own collection:
